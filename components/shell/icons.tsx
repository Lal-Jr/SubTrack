...
export const icons: Record<string, ReactElement> = {
    overview: <svg {...base}><rect x="3" y="3" width="7" height="9" rx="1.5" /><rect x="14" y="3" width="7" height="5" rx="1.5" /><rect x="14" y="12" width="7" height="9" rx="1.5" /><rect x="3" y="16" width="7" height="5" rx="1.5" /></svg>,
    subscriptions: <svg {...base}><path d="M4 7h16M4 12h16M4 17h10" /></svg>,
    insights: <svg {...base}><path d="M4 20V10M10 20V4M16 20v-7M22 20H2" /></svg>,
    import: <svg {...base}><path d="M12 3v12M7 10l5 5 5-5M4 20h16" /></svg>,
